  ...
  return (
    <div className="space-y-6 p-6">
      <header className="flex items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-semibold cf-text">Modifica sessione</h1>
      ...
      <div className="cf-card">
        <SessionForm
          mode={{
            kind: "edit",
            id: a.id,
            defaults: { ...a, durationMin },
          }}
        />
      </div>

      <Link
        href={`/app/clients/${a.client.slug}?tab=sessions`}
        className="text-sm cf-faint hover:underline"
      >
        Vai al cliente →
      </Link>
    </div>
