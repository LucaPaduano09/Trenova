      ...
      <main className="relative mx-auto max-w-6xl px-6 pb-20">
        ...
        <section className="grid items-start gap-12 pt-10 lg:grid-cols-[1.04fr_0.96fr] lg:pt-14">
          <div className="relative">
            ...
            <p className="mt-5 max-w-2xl text-base leading-8 text-white/70 sm:text-lg">
              ...
              <span className="text-white">progressi</span> in un’unica esperienza
              prodotto: più controllo operativo, più valore percepito, meno
              attrito in ogni momento del lavoro.
            </p>
              ...
              <div className="relative aspect-[16/10]">
                ...
                <div className="absolute bottom-5 right-5 rounded-2xl border border-white/10 bg-black/25 px-4 py-3 backdrop-blur-xl">
                  ...
                  <div className="mt-2 flex items-end gap-2">
                    <div className="text-2xl font-semibold text-white">+wow</div>
                    <div className="pb-1 text-sm text-white/60">per PT e clienti</div>
                  </div>
                </div>
              </div>
        ...
        <section className="mt-6 grid gap-3 sm:grid-cols-3">
          <div className="rounded-[24px] border border-white/10 bg-white/[0.045] p-5 backdrop-blur-xl">
            ...
            <div className="mt-2 text-2xl font-semibold text-white">Zero caos</div>
          ...
          <div className="rounded-[24px] border border-white/10 bg-white/[0.045] p-5 backdrop-blur-xl">
            ...
            <div className="mt-2 text-2xl font-semibold text-white">Retention</div>
            <div className="mt-2 max-w-sm text-sm leading-7 text-white/60">
